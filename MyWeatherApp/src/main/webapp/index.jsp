...
<body><div class="glass-container">
      <div class="container">
        <form action="MyServlet" method="post" >
          <input type="text" name="city"  placeholder="Search any city..." />
        ...
        <div class="temperature-info">
          <img
            src="images/360_F_117285131_W2qjuUEEBPP2nPJHxosDk62mj4B6KvIg.jpg"
            alt="" id="weather-icon"
          />
          <h2>${temperature} °C</h2>
          <input type="hidden" id="wc" value="${weatherConditon}">
